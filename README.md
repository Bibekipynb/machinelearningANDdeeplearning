...
<img width="749" height="578" alt="image" src="https://github.com/user-attachments/assets/8c4e5c7f-4762-4244-a4aa-2ed070e8b7d7" />
 ...
 It was a toy dataset with random parameters so the predictions at first were terrible. After training the model the predictions were better. I also tested the model using the test dataset and it was doing decent. 
